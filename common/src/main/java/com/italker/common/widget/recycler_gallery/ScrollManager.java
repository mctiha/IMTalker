...
public class ScrollManager {
    ...
    public void updateComsume() {
        mConsumeX += ScreenUtils.dipToPx(GalleryItemDecoration.mLeftPageVisibleWidth + GalleryItemDecoration.mPageMargin * 2);
        mConsumeY += ScreenUtils.dipToPx(GalleryItemDecoration.mLeftPageVisibleWidth + GalleryItemDecoration.mPageMargin * 2);
