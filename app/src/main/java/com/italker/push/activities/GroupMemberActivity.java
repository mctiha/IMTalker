...
import com.italker.factory.presenter.group.GroupMembersContract;
import com.italker.factory.presenter.group.GroupMembersPresenter;
import com.italker.push.fragment.group.GroupMemberAddFragment;
...
public class GroupMemberActivity extends PresenterToolbarActivity<GroupMembersContract.Presenter>
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.chat_group, menu);

        MenuItem menuItem =  mToolbar.getMenu().findItem(R.id.action_add);
        // 显示管理员界面，添加成员
        menuItem.setVisible(mIsAdmin);
