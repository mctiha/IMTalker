...
import com.italker.common.permissiongen.PermissionGen;
...
import com.italker.push.activities.AccountActivity;
import com.italker.push.activities.MainActivity;
import com.italker.push.fragment.assist.PermissionsFragment;
    ...
    private void skip() {
        startAnim(1f, new Runnable() {
            ...
            public void run() {
                ...
                PermissionGen.needPermission(LaunchActivity.this, 100, perms);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == 100) {
            if(Build.VERSION.SDK_INT >= 23
                    ...
                    && this.checkSelfPermission(Manifest.permission.ACCESS_WIFI_STATE) == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(LaunchActivity.this, getString(R.string.rc_permission_grant_needed), Toast.LENGTH_SHORT).show();
                finish();
            }
        }
    }
